...
namespace Elementor;
use WP_Query;
class ThemeDraft_Team_Member_One_Widget extends Widget_Base {

	public function get_name() {

		return 'themedraft_team_member_one';
	}

	public function get_title() {
		return esc_html__( 'Team Member One', 'themedraft-core' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'description' => esc_html__( 'Use 270x275 pixel Image for better user experience.', 'themedraft-core' ),
			]
		);
                                    ...
                                    <div class="td-single-team-member">
                                        <div class="member-image-wrapper">
                                            ...
                                            <a class="td-member-details-url" href="<?php the_permalink(); ?>">
                                                <div class="td-member-btn-text"><span><?php echo $settings['btn_text'];?></span></div>
                                            <?php endif; ?>
...
Plugin::instance()->widgets_manager->register( new ThemeDraft_Team_Member_One_Widget );